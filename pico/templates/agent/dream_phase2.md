...
- Batch changes to the same file into one patch_file call when possible
...
- Reference specific tools the agent has access to, such as read_file, write_file, patch_file, search, and run_shell
